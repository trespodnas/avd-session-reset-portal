...
DUMMY_EMAIL_ADDRESS = 'enter_your_email_address@here.org'
...
def get_email():
    ...
    users_token = get_user_token_from_state(email)
    if email in get_user_upn_from_state(email) and users_token == get_user_token_from_state(email):
